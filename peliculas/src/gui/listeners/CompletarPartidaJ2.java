...
public class CompletarPartidaJ2 implements ActionListener {
	...
	public CompletarPartidaJ2(DatosPrograma datos, JList<Partida> partidasJ2, JList<Partida> partidasComp,JFrame frame) {

		// TODO Auto-generated constructor stub
		

		datosBackup=datos;
		partidasJ1Backup=partidasJ2;
		padre=frame;
	...
	public void actionPerformed(ActionEvent e) {
			     ...
			     while(salida==false) {
					...
					if(pregunta1.isEmpty()) { /*||pregunta2.isEmpty() || pregunta3.isEmpty() ||pregunta4.isEmpty() ||pregunta5.isEmpty() ||pregunta6.isEmpty()){*/
						...
						try {
							...
							if (p0[z].respuestaCorrecta(pregunta1, false)==true)
							{
								...
								{
									salida=true;
									partida.finalizar_Partida(false);
		...
		Vector<Partida> aux=new Vector<>();
	     for(Partida p:datosBackup.getUsuarioActual().getpartidas_pendientesj2()) {
	    	 aux.addElement(p);
	     }
		...
		Vector<Partida> auxComp= new Vector<>();
		 ...
		 datosBackup.getClasificacion().actualizar(partida);
